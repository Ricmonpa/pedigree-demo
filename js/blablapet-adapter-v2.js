// API keys ahora están protegidas en el backend - V2
...
export async function analyzeVideoBehavior(videoFile) {
    try {
        console.log('🎬 Analizando comportamiento del video... V2');
        ...
        console.error('❌ Error en análisis de comportamiento V2:', error);
